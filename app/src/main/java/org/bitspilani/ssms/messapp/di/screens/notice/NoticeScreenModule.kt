...
class NoticeScreenModule {
    ...
    @Provides
    fun providesNoticeRepository(sharedPreferences: SharedPreferences, noticesDao: NoticesDao, networkWatcher: NetworkWatcher, noticeService: NoticeService): NoticeRepository = NoticeRepositoryImpl(sharedPreferences, noticesDao, networkWatcher, noticeService)
