...
@Database(entities = [DataLayerMenuItem::class, DataLayerNotice::class, DataLayerGrub::class, DataLayerGrubBatch::class, DataLayerTicket::class, DataLayerContact::class], version = 1)
